...
client.on('message', msg => {
  ...
  if (msg.content.toLowerCase().includes('of')) {
   	msg.reply('Of deme ah de!');
  }
  if (msg.content.toLowerCase().includes('ah')) {
   	msg.reply('Ah deme oh de!');
  }
  if (msg.content.toLowerCase().includes('oh')) {
   	msg.reply('Oh deme püf de!');
  }
  if (msg.content.toLowerCase().includes('püf')) {
  ...
  if (msg.content.toLowerCase().includes('selamın aleyküm')) {
   	msg.reply('aleyküm selam');
  }
  if (msg.content.toLowerCase().includes('güle güle')) {
